...
@Service
public class ResearcherServiceImpl<T extends GenericJPAEntity, S extends Serializable>  extends GenericServiceImpl<Researcher, UUID> implements ResearcherService<Researcher, UUID> {
