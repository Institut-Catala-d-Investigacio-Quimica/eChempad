...
public class ResearcherControllerImpl<T extends GenericJPAEntity, S extends Serializable> extends GenericControllerImpl<Researcher, UUID> implements ResearcherController<Researcher, UUID>  {
